      ...
      <section className="relative py-32 overflow-hidden border-b border-gray-900">
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-5xl sm:text-6xl font-black text-white mb-6 tracking-tight">
            Our Mission: Empowering <span className="text-blue-500">Creators</span>
          </h1>
          ...
          <div className="grid gap-16">
            ...
            <div className="bg-gray-900 border border-gray-800 p-10 rounded-3xl">
              <div className="max-w-3xl">
                ...
                <h3 className="text-xl font-bold text-blue-500 mb-4">Rondell Cobbs II · Music Producer</h3>
      ...
      <section className="py-20 bg-gray-900/30 border-t border-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/signup" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded-xl transition-colors">
              Create Account
            </Link>
