...
export default function AnalyticsPage() {
  ...
  const revenueBreakdown = data?.licenseTypes.map((lt) => ({
    ...
    color: lt.name.startsWith("Basic") ? "bg-blue-700"
         : lt.name.startsWith("Premium") ? "bg-blue-700"
         : "bg-violet-500",
  })) ?? [];
  ...
  const intensityColor = (v: number) =>
    v > 80 ? "bg-blue-700" : v > 60 ? "bg-blue-900/30" : v > 40 ? "bg-blue-900/30" : v > 20 ? "bg-blue-900/30" : "bg-gray-800";
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {(data?.licenseTypes ?? []).map((lt, i) => {
                  const colors = ["bg-blue-700", "bg-blue-700", "bg-violet-500"];
                  return (
                    <div key={lt.name}>
              ...
              {geographyData.map((g, i) => (
                <div key={g.code} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-2 bg-gray-800 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-blue-600 to-blue-400 rounded-full" style={{ width: `${g.pct}%` }} />
                  </div>
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[320px]">
                ...
                <div className="flex items-center gap-2 mt-3 justify-end">
                  ...
                  {["bg-gray-800","bg-blue-900/30","bg-blue-900/30","bg-blue-900/30","bg-blue-700"].map((c,i) => (
          ...
          <div className="grid sm:grid-cols-2 gap-8">
                ...
                {ageGroups.map((ag) => (
                  <div key={ag.group} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-5 bg-gray-800 rounded overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-blue-600 to-violet-600 flex items-center pl-2" style={{ width: `${ag.pct}%` }}>
            ...
            <div>
              ...
              <div className="h-6 bg-gray-800 rounded-lg overflow-hidden flex">
                ...
                <div className="bg-blue-800/10 h-full flex items-center justify-center" style={{ width: "31%" }}>
