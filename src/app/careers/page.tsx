      ...
      <section className="relative pt-32 pb-24 overflow-hidden border-b border-gray-900">
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-5xl sm:text-6xl font-black text-white mb-6 tracking-tight">
            Build the Future of <span className="text-blue-500">Sound</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-blue-600/20 rounded-xl flex items-center justify-center text-blue-400 mx-auto mb-6">
      ...
      <section className="py-20 bg-gray-900/20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {positions.map((pos) => (
              <div key={pos.title} className="group bg-gray-900 border border-gray-800 p-6 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-blue-500/40 transition-all">
                <div>
                  <h3 className="text-lg font-bold text-white mb-1 group-hover:text-blue-400 transition-colors">{pos.title}</h3>
          ...
          <div className="mt-12 p-8 border border-dashed border-gray-800 rounded-2xl text-center">
            ...
            <a href="mailto:careers@wavr.music" className="text-blue-500 font-bold hover:underline">
              careers@wavr.music
            </a>
          </div>
        </div>
