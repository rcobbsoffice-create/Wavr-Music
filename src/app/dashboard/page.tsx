  ...
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <form onSubmit={handleSave} className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5">
        {msg && (
          <p className={`text-sm ${msg.includes("success") ? "text-green-400" : "text-blue-400"}`}>{msg}</p>
        )}
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm focus:outline-none focus:border-blue-600"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={saving}
          className="bg-blue-700 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold px-6 py-2.5 rounded-lg text-sm"
        >
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="space-y-3">
                      {(stats?.topBeats ?? []).map((beat, i) => (
                        <div key={beat.id} className="flex items-center gap-3">
                          ...
                          <div className="w-8 h-8 rounded bg-gradient-to-br from-blue-600 to-blue-400 shrink-0" />
                          <div className="flex-1 min-w-0">
          ...
          {activeTab === "music" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Link href="/producer" className="bg-blue-700 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg">
                  + Upload Beat
                </Link>
              </div>
                    ...
                    {loadingBeats ? (
                      ...
                      <tr>
                        <td colSpan={5} className="px-5 py-10 text-center text-gray-500">
                          ...
                          <Link href="/producer" className="text-blue-400 hover:text-blue-400">Upload your first beat →</Link>
                        </td>
                      </tr>
                    ) : (
                      myBeats.map((beat) => (
            ...
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  { label: "Total Paid Out", value: loadingStats ? "—" : `$${(stats?.payoutHistory ?? []).filter((p) => p.status === "completed").reduce((s, p) => s + p.amount, 0).toFixed(2)}`, color: "from-blue-600/30 to-gray-900 border-blue-700/30" },
                ].map((p) => (
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
                ...
                {payoutMsg && (
                  <p className={`text-sm ${payoutMsg.includes("submitted") ? "text-green-400" : "text-blue-400"}`}>
                    {payoutMsg}
                  </p>
                )}
                <div className="flex gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Amount"
                      className="bg-gray-800 border border-gray-700 rounded-lg pl-7 pr-4 py-2.5 text-white text-sm focus:outline-none focus:border-blue-600 w-36"
                    />
                  </div>
                  <button
                    onClick={handlePayoutRequest}
                    disabled={payoutSubmitting}
                    className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-600 hover:to-blue-400 disabled:opacity-50 text-white font-bold px-6 py-2.5 rounded-xl text-sm"
                  >
          ...
          {activeTab === "analytics" && (
            <div className="text-center py-20">
              ...
              <Link href="/analytics" className="bg-gradient-to-r from-blue-600 to-blue-400 text-white font-bold px-6 py-3 rounded-xl">
                Open Analytics →
              </Link>
            </div>
          )}
