    ...
    <>
      <div className="min-h-screen bg-gray-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          {/* How it works */}
          <div className="bg-gradient-to-r from-blue-600/20 via-gray-900/50 to-blue-400/20 border border-blue-700/30 rounded-2xl p-6 mb-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <a
                href="/dashboard"
                className="shrink-0 bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-600 hover:to-blue-400 text-white font-bold px-6 py-3 rounded-xl text-sm"
              >
          ...
          <div className="mt-16 text-center bg-gray-900 border border-gray-800 rounded-2xl p-10">
            ...
            <a
              href="/dashboard"
              className="inline-block bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-600 hover:to-blue-400 text-white font-bold px-8 py-3 rounded-xl"
            >
              Start Selling Merch →
            </a>
          </div>
