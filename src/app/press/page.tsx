      ...
      <section className="pt-32 pb-24 border-b border-gray-900">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-5xl sm:text-6xl font-black text-white mb-6 tracking-tight">
            Press & <span className="text-blue-500">Media</span>
          </h1>
          ...
          <div className="mb-20">
            ...
            <div className="space-y-4">
              {releases.map((release) => (
                <Link key={release.title} href={release.link} className="flex flex-col sm:flex-row sm:items-center justify-between p-6 bg-gray-900 border border-gray-800 rounded-2xl hover:border-blue-500/40 transition-all group">
                  <span className="text-white font-semibold group-hover:text-blue-400 transition-colors">{release.title}</span>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={asset.title} className="p-6 bg-gray-900 border border-gray-800 rounded-2xl text-center">
                  ...
                  <button className="text-blue-400 text-xs font-bold hover:underline">Download</button>
                </div>
              ))}
            </div>
          </div>
