        ...
        <div className="max-w-4xl mx-auto px-4 prose prose-invert prose-red">
          <div className="space-y-12">
            ...
            <div className="pt-10 border-t border-gray-900">
              <p className="text-sm">If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@wavr.music" className="text-blue-400 hover:underline">privacy@wavr.music</a>.</p>
            </div>
          </div>
        </div>
      </section>
