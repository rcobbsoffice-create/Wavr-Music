        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="relative max-w-2xl mx-auto">
            <input
              ...
              className="w-full bg-gray-900 border border-gray-800 rounded-2xl px-6 py-4 pl-14 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-xl transition-all"
            />
          ...
          <p className="mt-6 text-sm text-gray-500">
            Popular: <span className="text-blue-400 cursor-pointer hover:underline">Payouts</span>, <span className="text-blue-400 cursor-pointer hover:underline">Exclusive Licenses</span>, <span className="text-blue-400 cursor-pointer hover:underline">Uploading Stems</span>
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((cat) => (
              <div key={cat.title} className="flex flex-col">
                ...
                <Link href="#" className="mt-6 text-xs font-bold text-white uppercase tracking-widest hover:text-blue-400 transition-colors">
                  View All →
                </Link>
              </div>
            ))}
      ...
      <section className="py-20 bg-gray-900/30 border-t border-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/support" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded-xl transition-colors">
              Open a Ticket
            </Link>
