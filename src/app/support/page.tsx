    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <Link href="/support/help" className="bg-gray-900 border border-gray-800 p-6 rounded-2xl hover:border-blue-700/30 transition-all group">
            <div className="text-blue-400 mb-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <h3 className="text-white font-bold mb-1 group-hover:text-blue-400 transition-colors">Help Center</h3>
          ...
          <Link href="/support/contact" className="bg-gray-900 border border-gray-800 p-6 rounded-2xl hover:border-fuchsia-500/30 transition-all group">
            ...
            <h3 className="text-white font-bold mb-1 group-hover:text-blue-400 transition-colors">Contact Us</h3>
        ...
        {!showForm ? (
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-600 hover:to-blue-400 text-white font-bold px-6 py-3 rounded-xl"
          >
            + Open New Ticket
          </button>
        ) : (
          <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm focus:outline-none focus:border-blue-600"
              >
            ...
            <div className="space-y-4">
              {tickets.map((ticket) => (
                <div key={ticket.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                  ...
                  {ticket.response && (
                    <div className="bg-blue-900/30 border border-blue-700/30 rounded-lg p-3 mt-3">
                      <p className="text-blue-400 text-xs font-semibold mb-1">Support Response</p>
