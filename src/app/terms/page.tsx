        ...
        <div className="max-w-4xl mx-auto px-4 prose prose-invert prose-red">
          <div className="space-y-12">
            ...
            <div className="pt-10 border-t border-gray-900">
              <p className="text-sm">For questions regarding these terms, please contact <a href="mailto:legal@wavr.music" className="text-blue-400 hover:underline">legal@wavr.music</a>.</p>
            </div>
          </div>
        </div>
      </section>
