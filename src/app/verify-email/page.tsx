      ...
      <div className="mt-8 bg-gray-900 border border-gray-800 rounded-2xl p-10 shadow-2xl">
        {status === "loading" && (
          <div className="space-y-4">
            <div className="w-14 h-14 rounded-full border-2 border-blue-600 border-t-transparent animate-spin mx-auto" />
        ...
        {status === "success" && (
          <div className="space-y-4">
            ...
            <Link
              href="/producer"
              className="inline-block mt-2 bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-600 hover:to-blue-400 text-white font-bold px-6 py-2.5 rounded-xl transition-all text-sm"
            >
              Go to Dashboard
            </Link>
          </div>
        ...
        {status === "error" && (
          <div className="space-y-4">
            <div className="w-16 h-16 rounded-full bg-blue-900/30 border border-blue-700/30 flex items-center justify-center mx-auto">
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[400px] bg-blue-900/30 rounded-full blur-[120px]" />
      </div>
...
function ResendButton() {
  ...
  return sent ? (
    ...
    <button
      onClick={resend}
      disabled={sending}
      className="text-blue-400 hover:text-blue-400 text-sm font-medium transition-colors disabled:opacity-60"
    >
