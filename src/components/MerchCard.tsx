...
const CATEGORY_GRADIENTS: Record<string, string> = {
  "T-Shirts":    "from-blue-600 via-violet-900 to-black",
...
export default function MerchCard({ item }: MerchCardProps) {
  ...
  const gradient = CATEGORY_GRADIENTS[item.category] ?? "from-blue-600 via-gray-900 to-black";
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-blue-700/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/20 group">
