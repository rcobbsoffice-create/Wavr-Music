...
interface PlayerContextType {
  ...
  togglePlay: () => void;
  watermarkedActive: boolean;
  setWatermarkedActive: (active: boolean) => void;
}
...
export function PlayerProvider({ children }: { children: ReactNode }) {
  ...
  const [watermarkedActive, setWatermarkedActive] = useState(false);
  ...
  return (
    <PlayerContext.Provider value={{ currentBeat, isPlaying, setCurrentBeat, togglePlay, watermarkedActive, setWatermarkedActive }}>
      {children}
